...
public class staticJx_jsbh extends JFrame {
	public staticJx_jsbh() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (c1.equals("")) {
					...
					try {
						...
						String sql = "SELECT * FROM 教师教学信息  WHERE 教师编号 LIKE" + "'%" + c1 + "%'";
						...
						columnName.add("课程编号");
						columnName.add("教师姓名");
						new DBtoExcel().WriteExcel(rs, "E://statisJx_jsbh.xls", "教师教学信息_教师编号", columnName);
