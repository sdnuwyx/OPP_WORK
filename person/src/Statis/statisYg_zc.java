...
public class statisYg_zc extends JFrame {
	public statisYg_zc() {
		...
		JFrame framestaff = new JFrame("转出员工");
		...
		try {
			...
			String sql = "select * from 转出教师 union select * from 教师信息 where 在职信息='转出'";
			...
			final JFrame f = new JFrame("转出教师");
			...
			columnName.add("在职信息");
			columnName.add("部门编号");
			new DBtoExcel().WriteExcel(rs, "E://statisYg_zc.xls", "转出教师", columnName);
									...
									public void actionPerformed(ActionEvent e) {
										...
										if (c1.equals("")) {
											...
											try {
												...
												String sql = "SELECT * FROM 转出教师  WHERE 性别 LIKE" + "'%" + c1 + "%'"+" union SELECT * FROM 教师信息  WHERE 性别 LIKE" + "'%" + c1 + "%'"+" and 在职信息='转出'";
												st = conn.createStatement();
												rs = st.executeQuery(sql);
												int count = 0;
												while (rs.next()) {
												...
												columnName.add("在职信息");
												columnName.add("部门编号");
												new DBtoExcel().WriteExcel(rs, "E://statisYg_zc_xb.xls", "教师信息_性别",
														columnName);
									...
									public void actionPerformed(ActionEvent e) {
										...
										if (c1.equals("")) {
											...
											try {
												...
												conn.setAutoCommit(true);
												System.out.println("已经连接到数据库...");
												String sql = "SELECT * FROM 转出教师  WHERE 学历 LIKE" + "'%" + c1 + "%'"+" union SELECT * FROM 教师信息  WHERE 学历 LIKE" + "'%" + c1 + "%'"+" and 在职信息='转出'";
												st = conn.createStatement();
												rs = st.executeQuery(sql);
												int count = 0;
												while (rs.next()) {
												...
												columnName.add("在职信息");
												columnName.add("部门编号");
												new DBtoExcel().WriteExcel(rs, "E://statisYg_zc_xl.xls", "教师信息_学历",
														columnName);
											} catch (SQLException e1) {
												java.lang.System.out.println("异常" + e1);
											} finally {
									...
									public void actionPerformed(ActionEvent e) {
										...
										if (c1.equals("")) {
											...
											try {
												...
												conn.setAutoCommit(true);
												System.out.println("已经连接到数据库...");
												String sql = "SELECT * FROM 转出教师  WHERE 职务 LIKE" + "'%" + c1 + "%'"+" union SELECT * FROM 教师信息  WHERE 职务 LIKE" + "'%" + c1 + "%'"+" and 在职信息='转出'";
												st = conn.createStatement();
												rs = st.executeQuery(sql);
												int count = 0;
												while (rs.next()) {
												...
												columnName.add("在职信息");
												columnName.add("部门编号");
												new DBtoExcel().WriteExcel(rs, "E://statisYg_zc_zw.xls", "教师信息_职务",
														columnName);
											} catch (SQLException e1) {
												java.lang.System.out.println("异常" + e1);
											} finally {
									...
									public void actionPerformed(ActionEvent e) {
										...
										if (c1.equals("")) {
											...
											try {
												...
												conn.setAutoCommit(true);
												System.out.println("已经连接到数据库...");
												String sql = "SELECT * FROM 转出教师  WHERE 职称 LIKE" + "'%" + c1 + "%'"+" union SELECT * FROM 教师信息  WHERE 职称 LIKE" + "'%" + c1 + "%'"+" and 在职信息='转出'";
												st = conn.createStatement();
												rs = st.executeQuery(sql);
												int count = 0;
												while (rs.next()) {
												...
												columnName.add("在职信息");
												columnName.add("部门编号");
												new DBtoExcel().WriteExcel(rs, "E://statisYg_zc_zc.xls", "教师信息_职称",
														columnName);
											} catch (SQLException e1) {
												java.lang.System.out.println("异常" + e1);
											} finally {
									...
									public void actionPerformed(ActionEvent e) {
										...
										if (c1.equals("")) {
											...
											try {
												...
												conn.setAutoCommit(true);
												System.out.println("已经连接到数据库...");
												String sql = "SELECT * FROM 转出教师  WHERE 部门编号 LIKE" + "'%" + c1 + "%'"+" union SELECT * FROM 教师信息  WHERE 部门编号 LIKE" + "'%" + c1 + "%'"+" and 在职信息='转出'";
												st = conn.createStatement();
												rs = st.executeQuery(sql);
												int count = 0;
												while (rs.next()) {
												...
												columnName.add("在职信息");
												columnName.add("部门编号");
												new DBtoExcel().WriteExcel(rs, "E://statisYg_zc_bmbh.xls", "教师信息_部门编号",
														columnName);
											} catch (SQLException e1) {
												java.lang.System.out.println("异常" + e1);
											} finally {
