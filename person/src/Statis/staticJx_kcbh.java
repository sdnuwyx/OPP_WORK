...
public class staticJx_kcbh extends JFrame {
	public staticJx_kcbh() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (c1.equals("")) {
					...
					try {
						...
						String sql = "SELECT * FROM 教师教学信息  WHERE 课程编号 LIKE" + "'%" + c1 + "%'";
						...
						columnName.add("课程编号");
						columnName.add("教师姓名");
						new DBtoExcel().WriteExcel(rs, "E://statisJx_kcbh.xls", "教师教学信息_课程编号", columnName);
